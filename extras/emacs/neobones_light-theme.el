...
;; black: []
 ...
 `(success ((,class (:foreground "#567A30"))))
 `(git-gutter:added ((,class (:foreground "#567A30"))))
 ...
 `(flycheck-error ((,class (:foreground "#A8334C" :background "#EDDBDD"))))
 `(flycheck-warning ((,class (:foreground "#944927" :background "#EEDCD8"))))
 `(flycheck-info ((,class (:foreground "#286486" :background "#D5E1ED"))))
