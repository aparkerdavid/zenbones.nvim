...
;; black: []
 ...
 `(link ((,class (:foreground "#90AFFA" :underline 't))))
 ...
 `(success ((,class (:foreground "#74DBCB"))))
 `(git-gutter:added ((,class (:foreground "#74DBCB"))))
 `(git-gutter:deleted ((,class (:foreground "#F77890"))))
 `(git-gutter:modified ((,class (:foreground "#7BA2F7"))))
 ...
 `(flycheck-error ((,class (:foreground "#F77890" :background "#292223"))))
 `(flycheck-warning ((,class (:foreground "#E1B068" :background "#252322"))))
 `(flycheck-info ((,class (:foreground "#7BA2F7" :background "#222427"))))
