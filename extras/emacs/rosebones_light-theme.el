...
;; black: []
 ...
 `(success ((,class (:foreground "#286A84"))))
 `(git-gutter:added ((,class (:foreground "#286A84"))))
 `(git-gutter:deleted ((,class (:foreground "#B5637A"))))
 `(git-gutter:modified ((,class (:foreground "#5795A0"))))
 ...
 `(flycheck-error ((,class (:foreground "#B5637A" :background "#F4E8EB"))))
 `(flycheck-warning ((,class (:foreground "#EC9D33" :background "#F4E9E2"))))
 `(flycheck-info ((,class (:foreground "#5795A0" :background "#DAEFF3"))))
 ...
 `(link ((,class (:foreground "#407D88" :underline 't))))
